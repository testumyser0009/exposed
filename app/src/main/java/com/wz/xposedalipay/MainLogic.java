...
import com.wz.xposedalipay.boradcast.AlipayBroadcast;
import com.wz.xposedalipay.boradcast.PluginBroadcast;
...
import static com.wz.xposedalipay.VersionParam.ALIPAY_PACKAGE_NAME;
...
public class MainLogic implements IXposedHookLoadPackage {
    ...
    public static String getCookieStr() {
        ...
        // 获得cookieStr
        if (m_lpparam != null) {
            callStaticMethod(findClass("com.alipay.mobile.common.transportext.biz.appevent.AmnetUserInfo", MainLogic.m_lpparam.classLoader), "getSessionid");
            Context context = (Context) callStaticMethod(findClass("com.alipay.mobile.common.transportext.biz.shared.ExtTransportEnv", MainLogic.m_lpparam.classLoader), "getAppContext");
            if (context != null) {
                Object readSettingServerUrl = callStaticMethod(findClass("com.alipay.mobile.common.helper.ReadSettingServerUrl", MainLogic.m_lpparam.classLoader), "getInstance");
                if (readSettingServerUrl != null) {
                    String gWFURL = (String) callMethod(readSettingServerUrl, "getGWFURL", context);
                    cookieStr = (String) callStaticMethod(findClass("com.alipay.mobile.common.transport.http.GwCookieCacheHelper", MainLogic.m_lpparam.classLoader), "getCookie", gWFURL);
                }
            }
        }
        return cookieStr;
